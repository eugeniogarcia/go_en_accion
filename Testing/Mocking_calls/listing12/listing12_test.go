...
// Usa un mock para emular el servifot, la api
package listing12
...
// Crea una función que devuelve el mock
func mockServer() *httptest.Server {
	//Función con el mock. w es la respuesta, r la petición
	f := func(w http.ResponseWriter, r *http.Request) {
		w.WriteHeader(200)
		w.Header().Set("Content-Type", "application/xml")
		fmt.Fprintln(w, feed)
	}
	//Crea el mock con la función
